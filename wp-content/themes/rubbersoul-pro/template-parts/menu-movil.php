...
<div id="menu-movil">
	<div class="search-form-movil">
		<form method="get" id="searchform-movil" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<input type="search" class="txt-search-movil" placeholder="<?php _e('Search...', 'rubbersoul-pro'); ?>" name="s" id="s" />
			<input type="submit" name="submit" id="btn-search-movil" value="<?php _e( 'Search', 'rubbersoul-pro' ); ?>" />
		</form>
	...
	<div class="social-icon-wrapper-movil">
			...
			<?php if( get_theme_mod( 'rubbersoul_pro_googleplus_url' ) !== '' ) { ?>
				<a href="<?php echo esc_url(get_theme_mod( 'rubbersoul_pro_googleplus_url', 'https://plus.google.com/' )); ?>" title="Google Plus" target="_blank"><i class="fa fa-google-plus"></i></a>
			<?php } ?>
			...
			<?php if( get_theme_mod( 'rubbersoul_pro_rss_url' ) !== '' ) { ?>
				<a class="rss" href="<?php echo esc_url(get_theme_mod( 'rubbersoul_pro_rss_url', 'http://wordpress.org/' )); ?>" title="RSS" target="_blank"><i class="fa fa-rss"></i></a>			
			<?php } ?>
