...
<body <?php body_class(); ?>>
	...
	<?php if (!dynamic_sidebar ('wt-sobre-cabecera')) {}?>
			...
			<div class="wrapper-site-navigation">
				...
				<div class="wrapper-search-top-bar">
                	<div class="search-top-bar">
						<?php get_template_part(RUBBERSOUL_PRO_TEMPLATE_PARTS . 'searchform-toggle'); ?>
                    </div>
                </div>
	...
	<div style="position:relative; clear:both;">
		<?php get_template_part(RUBBERSOUL_PRO_TEMPLATE_PARTS . 'menu-movil'); ?>
    </div>
    
	</div><!-- wrapper-cabecera -->
	
	<div class="wrapper-area-widget-superior area-widget-padding-top">
	<?php if (!dynamic_sidebar ('wt-bajo-menu-principal')) {}?>
	</div>
