...
<?php /* New blog layout */ else : ?>
    ...
    <?php /* Get media */
        if( get_post_format() == 'video' || get_post_format() == 'audio' ) :
            $media_link = maskitto_light_get_media( get_the_ID() );
        else :
            $media_link = '';
        endif;
    ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-layout-2' ); ?>>
        ...
        <div class="blog-bottom" style="padding-bottom: 25px;">
            <div class="blog-content" style="font-size: 14px; padding-top: 30px; margin-bottom: 0;">
                <div class="post-inner"><?php echo str_replace( $media_link, '', apply_filters( 'the_content', get_the_content() ) ); ?></div>
            </div>
