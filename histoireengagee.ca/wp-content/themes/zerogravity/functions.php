...
$zerogravity_theme = wp_get_theme();
define('ZEROGRAVITY_VERSION', $zerogravity_theme -> get('Version'));
define('ZEROGRAVITY_AUTHOR_URI', $zerogravity_theme -> get('AuthorURI'));
define('ZEROGRAVITY_TEMPLATE_PARTS', 'template-parts/');
...
function zerogravity_setup() {
	...
	add_image_size('latest-th-60', 60, 60, true); // Preparar dimensiones para la version pro
	add_image_size('related-post-th-150', 150, 150, true); // Preparar dimensiones para la version pro
...
function zerogravity_entry_author(){
...
function zerogravity_entry_date() {
