...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			<?php if ( is_single() ) : 
			do_action('zerogravity_pre_post_title', $post->ID);
			?>
            ...
            <div class='sub-title'>
				<div class="autor-fecha">
                	<i class="fa fa-user"></i> <?php zerogravity_entry_author(); ?>
                 	&nbsp;&nbsp;<i class="fa fa-calendar-o"></i> <?php zerogravity_entry_date(); ?>
		...
		<footer class="entry-meta">
			...
			<?php 
			// Related posts
			if ( is_single() && get_theme_mod('zerogravity_related_posts', '') == 1) get_template_part(ZEROGRAVITY_TEMPLATE_PARTS . 'related-posts'); ?>
