...
$wp_customize->add_section('zerogravity_color_favicon_sidebar' , array(
	...
	'title' => __('ZG: Color and Sidebar','zerogravity'),
	'priority'    => '40',
));
// Color de tema
...
$wp_customize->add_setting('zerogravity_selected_text_bg_color', array('default' => '', 'sanitize_callback' => 'zerogravity_sanitize_checkbox',));
$wp_customize->add_control('zerogravity_selected_text_bg_color', array(
        'type' => 'checkbox',
        'label' => __('Apply to the background color of the selected text.', 'zerogravity'),
        'section' => 'zerogravity_color_favicon_sidebar',
		));
...
$wp_customize->add_setting('zerogravity_entrada_completa_en_home', array('default' => '', 'sanitize_callback' => 'zerogravity_sanitize_checkbox',));
$wp_customize->add_control('zerogravity_entrada_completa_en_home', array(
        'type' => 'checkbox',
        'label' => __("Show full posts on homepage.", 'zerogravity'),
