...
function hamza_lite_scripts() {	
	...
	$hamza_lite_query_args = array(
		'family' => 'Open+Sans:400,400italic,300italic,300,600,600italic|Titillium+Web:400,200,200italic,300,300italic,400italic,600,600italic,700,700italic,900|Yanone+Kaffeesatz:400,300,700,200',
		);
	...
	wp_enqueue_style( 'hamza-lite-bxslider-style', get_template_directory_uri() . '/css/jquery.bxslider.css' );
	...
	<div class="socials">
					...
					<?php if(!empty($hamza_lite_linkedin)){ ?>
						...
						function hamza_lite_logo_alignment_cb(){
							...
							if($hamza_lite_logo_alignment =="left"){
								...
								$hamza_lite_alignment_class="logo-right";
							}
		...
		// }
						...
						function hamza_lite_bxslidercb(){
							...
							$hamza_lite_slider_option = get_theme_mod('hamza_lite_slider_option', 'hide'); 
											...
											<div class="bx-slider">
												...
												foreach ($hamza_lite_sliders as $hamza_lite_slider){
													...
													if($hamza_lite_loop->have_posts()){ 
														...
														?>
														<div class="slides">
															<div class="slide-image" style="background-image: url('<?php echo esc_url($hamza_lite_image[0]); ?>')"></div>
		...
		function hamza_lite_web_layout( $hamza_lite_classes ){
			...
			if($hamza_lite_slider_option=='show' && is_front_page()){
				$hamza_lite_classes[]= 'yes-slider';
			}
...
<div class="coment-meta-wrap">
	...
	<div class="comment-meta"><a href="<?php echo htmlspecialchars( get_comment_link( $hamza_lite_comment->comment_ID ) ); ?>">
		...
		printf( __('%1$s %2$s', 'hamza-lite'), get_comment_date('M jS, Y'),  get_comment_time() ); ?></a><?php edit_comment_link( __( 'Edit', 'hamza-lite' ), '  ', '' );
		?>
	</div>    
	<?php comment_text(); ?>
</div>
...
/** Plugin Install ***/
function hamza_lite_required_plugins() {
...
$plugins = array(
	...
	*/
	$config = array(
		'default_path' => '',
		'menu'         => 'hamza-lite-install-plugins',
		'has_notices'  => true,
		'dismissable'  => true,
		'dismiss_msg'  => '',
		'is_automatic' => true,
		...
		'strings'      => array(
			...
			'notice_can_install_required'     => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.','hamza-lite' ),
			'notice_can_install_recommended'  => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.','hamza-lite' ),
			'notice_cannot_install'           => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.','hamza-lite' ),
			'notice_can_activate_required'    => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.','hamza-lite' ),
			'notice_can_activate_recommended' => _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.','hamza-lite' ),
			'notice_cannot_activate'          => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.','hamza-lite' ),
			'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.','hamza-lite' ),
			'notice_cannot_update'            => _n_noop( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.','hamza-lite' ),
			'install_link'                    => _n_noop( 'Begin installing plugin', 'Begin installing plugins','hamza-lite' ),
			'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins','hamza-lite' ),
			'return'                          => __( 'Return to Required Plugins Installer', 'hamza-lite' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'hamza-lite' ),
			'complete'                        => __( 'All plugins installed and activated successfully. %s', 'hamza-lite' ),
			'nag_type'                        => 'updated'
			)
		);
...
add_action( 'tgmpa_register', 'hamza_lite_required_plugins' );
