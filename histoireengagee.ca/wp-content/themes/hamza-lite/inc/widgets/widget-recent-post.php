            	...
            	<div class="hamza_lite-recent-rightdivs clearfix">
                	...
                	if($hamza_lite_display_thumbnail){ 
                		...
                		<?php 
                			...
                			<div class="hamza_lite-recent-rightbar-img">
                    			<a href="<?php the_permalink(); ?>"><img src="<?php echo esc_url(get_template_directory_uri().'/images/image400by400.jpg'); ?>" alt="<?php the_title();?>" /></a>
                			</div>
                		<?php
                		} 
                	}?>
                	<div class="hamza_lite-recent-rightbar-content">
                    	<h6 class="hamza_lite-recent-rightbar-title"><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a></h6>
                    	<?php 
