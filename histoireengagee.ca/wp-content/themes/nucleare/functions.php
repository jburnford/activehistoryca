...
function nucleare_scripts() {
	...
	wp_register_style( 'nucleare-googlefonts', add_query_arg( $query_args, "//fonts.googleapis.com/css" ), array(), null );
	wp_enqueue_style( 'nucleare-googlefonts' );
	...
	wp_enqueue_script( 'nucleare-html5shiv', get_template_directory_uri() . '/js/html5shiv.min.js', array(), '3.7.3', false );
	wp_script_add_data( 'nucleare-html5shiv', 'conditional', 'lt IE 9' );
}
